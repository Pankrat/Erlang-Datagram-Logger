"""
Demonstrate logging from Python to the Erlang logging service via datagrams
(UDP).
...
def set_up_logger(host="127.0.0.1", port=1056):
    logger = getLogger("erlang_logger")
    logger.setLevel(DEBUG)
    handler = ErlangDatagramHandler(host, port)
